...
# the four values below are copied from https://github.com/macports/macports-ports/blob/master/_resources/port1.0/fetch/archive_sites.tcl
# They need to match for the archives to be used
